...
class Circle:
    ...
    @radius.setter
    def radius(self, r):
        """set _radius, _diameter, _circumference and _area
    ...
    def diameter(self, d):
        """uses diameter d to set radius, which then 
         update all the related pseudo-private attributes """
        self.radius = d/2
    ...
    @property
    def area(self):
        "area ( PI x r square) of the circle object"
        return self._area
    
    @ area.setter
    def area(self, a):
        """uses area a to set radius, which then updates
            all related pseudo-private attributes"""
