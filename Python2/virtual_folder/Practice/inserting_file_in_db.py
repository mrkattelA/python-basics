...
with open(r"C:\Users\mrkat\OneDrive\Desktop\Webucator\Python2\working-with-data\data\states.txt") as f:
...
select = """SELECT state,
            CAST((pop2020*1.0/pop2000) * pop2020 AS INTEGER) pop2040
