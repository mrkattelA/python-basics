...
def make_choice():
    choice = input("""Chose your weapon:
1: Rock
2: Paper
3: Scissors
q: Quit
...
def main():
    ...
    while choice in ["1", "2", "3"]:
        your_play(weapons,choice,python_weapons)
        choice = make_choice()
    print("Goodbye!")
